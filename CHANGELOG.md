...
- use GitHub review decision for approval status

## [0.0.13] - 2026-09-24

### Added

- split PR state and review markers

## [0.0.12] - 2026-09-16

### Changed

- drop winit, imageproc, image and tracing-appender
- trim clap features and fix the cask zap path

## [0.0.11] - 2026-09-15

### Added

- copy a PR link with shift-click
...
- replace deprecated cask postflight with postflight_steps
- declare macos dependency and order cask stanzas

## [0.0.9] - 2026-05-06

### Fixed

- prepend Homebrew bin paths so GUI-launched app finds gh

## [0.0.8] - 2026-04-29

### Added

- restructure PR groups with assigned and review sections
